package com.ssafy.ssafyway.api.kakao.service;
...
import com.ssafy.ssafyway.api.kakao.data.dto.request.KakaoAPIRequest;
import com.ssafy.ssafyway.api.kakao.data.dto.response.KakaoAPIResponse;
import com.ssafy.ssafyway.api.kakao.data.vo.Documents;
import com.ssafy.ssafyway.api.kakao.property.KakaoAddressProperties;
...
public class KakaoMapFetchAPI implements FetchAPICore {
    ...
    private KakaoAPIRequest makeRoadAddress(String sggNm, String bjDongNm, String bobn, String bubn) {
        return KakaoAPIRequest.toRequest(
                sggNm + " " +
                bjDongNm + " " +
                bobn + "-" +
                bubn);
